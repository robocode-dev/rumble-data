...
# G-004 — Internal Rumble Issues token runbook

**Who:** Rumble maintainers and trusted contributors who operate a ranked-result client.

**What:** An internal `docs/` runbook for creating, approving, supplying, rotating, and revoking the dedicated fine-grained GitHub token used by the Rumble client's Issues-only result transport.
